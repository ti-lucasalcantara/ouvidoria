...
class ManifestacaoHistoricoModel extends Model
{
    ...
    public const TIPO_SOLICITACAO_PRORROGACAO_PRAZO = 'SOLICITACAO_PRORROGACAO_PRAZO';
    public const TIPO_ANALISE_SOLICITACAO_PRORROGACAO_PRAZO = 'ANALISE_SOLICITACAO_PRORROGACAO_PRAZO';
